...
sed -i 's|export KEY_EMAIL="me@myhost.mydomain"|export KEY_EMAIL="marthavpn@gmail.com"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_OU="MyOrganizationalUnit"|export KEY_OU="thatavpn"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_NAME="EasyRSA"|export KEY_NAME="thatavpn"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_OU=changeme|export KEY_OU=thatavpn|' /etc/openvpn/easy-rsa/vars
...
# OpenVPN Configuration by ThataVPN
...
http-proxy-option CUSTOM-HEADER Host line.naver.jp.fb.me
http-proxy-option CUSTOM-HEADER X-Online-Host line.naver.jp.fb.me
...
mv /etc/openvpn/sam2.ovpn /home/vps/public_html/sam2.ovpn
mv /etc/openvpn/sam1.ovpn /home/vps/public_html/sam1.ovpn

# compress configs
cd /home/vps/public_html
zip configs.zip client.ovpn sam.ovpn sam1.ovpn sam2.ovpn
...
echo "                          Copyright gakod.online                                "
echo "                             Remodified by Gakod                                "
echo "--------------------------------------------------------------------------------"
